...
constexpr short DIR_MAX					= 6;	//斜め移動を許可しない場合は4を、許可する場合は8を、6角形移動の場合は6指定。、
constexpr short MAP_WIDTHMAX			= 7;	//マップ幅
constexpr short MAP_HEIGHTMAX			= 7;	//マップ高さ
constexpr short COORDINATE_ELEMENT_MAX	= 2;	//x, yの２つ
